      ...
      <header className="fixed inset-x-0 top-4 z-40 px-4 sm:px-6">
        <div
          className={`mx-auto flex max-w-5xl items-center justify-between rounded-full border px-5 py-3 transition-all duration-300 ${
            scrolled
              ? "border-line-highlight bg-bg-primary/90 shadow-xl shadow-black/40 backdrop-blur-md"
              : "border-line bg-bg-surface/80 backdrop-blur-sm"
          }`}
        >
          ...
          <div className="hidden items-center gap-2 sm:flex">
            ...
            <button
              ...
              className="ml-1 flex items-center gap-1.5 rounded-full border border-structure/30 bg-structure/15 px-3 py-1.5 font-mono text-xs font-medium text-structure transition-colors hover:bg-structure/25"
            >
          ...
          <div className="mx-auto mt-2 max-w-5xl rounded-2xl border border-line bg-bg-surface/95 p-5 shadow-2xl backdrop-blur-xl md:hidden">
            <nav className="flex flex-col gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 py-1.5 text-left font-mono text-sm text-structure"
              >
