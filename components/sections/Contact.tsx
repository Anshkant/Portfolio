...
export function Contact() {
  ...
  return (
    ...
    >
      ...
      {/* Main Container */}
      <div className="relative overflow-hidden rounded-2xl border border-line bg-bg-surface p-6 shadow-2xl sm:rounded-3xl sm:p-12">
        ...
        <div className="max-w-3xl">
          {/* Status Indicator */}
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-1 font-mono text-xs text-emerald-400 sm:mb-6">
