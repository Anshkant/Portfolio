  ...
  return (
    ...
    >
      ...
      <div className="mb-10 flex flex-col justify-between gap-5 sm:mb-12 sm:gap-6 md:flex-row md:items-end">
        <div className="max-w-2xl">
          ...
          <p className="font-body text-sm text-text-muted sm:text-base">
            On-site internship at Atorix IT Solutions, published AI research,
      ...
      <div className="grid grid-cols-1 items-start gap-6 sm:gap-8 lg:grid-cols-12">
        {/* Left Column: Internship & Research */}
        <div className="space-y-6 lg:col-span-7">
          ...
          {profileData.internships.map((intern, i) => (
            <div
              key={i}
              className="space-y-5 rounded-2xl border border-line bg-bg-surface p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] sm:p-7"
            >
              <div className="flex flex-col justify-between gap-2 border-b border-line pb-4 sm:flex-row sm:items-baseline">
                ...
                <span className="self-start rounded-full border border-line bg-bg-primary px-3 py-1 font-mono text-xs text-text-muted sm:self-auto">
                  {intern.period}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-line/60 pt-3 font-mono text-xs text-text-muted">
          ...
          <div className="space-y-3 rounded-2xl border border-purple-500/30 bg-purple-950/20 p-5 sm:p-6">
            ...
            <p className="font-body text-xs text-text-muted">
              ...
              threat tracking with 92%+ accuracy and automated Telegram
              emergency alerts.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6 sm:space-y-8 lg:col-span-5">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {profileData.education.map((edu, i) => (
                <div
                  key={i}
                  className="rounded-2xl border border-line bg-bg-surface p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]"
                >
                  ...
                  {edu.score && (
                    <div className="inline-block rounded border border-signal/25 bg-signal/10 px-2.5 py-0.5 font-mono text-xs font-medium text-signal">
                      {edu.score}
                    </div>
                  )}
                  {edu.status && (
                    <div className="inline-block rounded border border-purple-500/30 bg-purple-500/10 px-2.5 py-0.5 font-mono text-xs font-medium text-purple-300">
                      {edu.status}
                    </div>
                  )}
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5 rounded-2xl border border-line bg-bg-surface p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
